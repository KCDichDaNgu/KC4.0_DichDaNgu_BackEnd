...
@click.option('-sk', '--ssl_keyfile', default=None, type=str)
@click.option('-sc', '--ssl_certfile', default=None, type=str)
...
def run_server_ssl(
    ...
    if ssl_keyfile is not None:
        ...
        overwrite_args['SSL_KEYFILE'] = ssl_keyfile

    if ssl_certfile is not None:
        
        overwrite_args['SSL_CERTFILE'] = ssl_certfile
