...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from modules.background_tasks.detect_file_language_created_by_private_request.main import main as detect_file_language_created_by_private_request
    
    background_task_1_conf = BACKGROUND_TASKS['detect_file_language_created_by_private_request']
    ...
    background_task_scheduler.add_job(
        detect_file_language_created_by_private_request,
