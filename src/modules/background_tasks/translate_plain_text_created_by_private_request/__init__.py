...
def add_fresh_jobs(background_task_scheduler: BackgroundTaskManager, BACKGROUND_TASKS):
    ...
    from modules.background_tasks.translate_plain_text_created_by_private_request.detect_content_language.main import main as detect_content_language
    from modules.background_tasks.translate_plain_text_created_by_private_request.translate_content.main import main as translate_content
    
    # background_task_1_conf = BACKGROUND_TASKS['translate_plain_text_created_by_private_request.detect_content_language']
    ...
    background_task_2_conf = BACKGROUND_TASKS['translate_plain_text_created_by_private_request.translate_content']
