...
def add_fresh_jobs(background_task_scheduler: BackgroundTaskManager, BACKGROUND_TASKS):
    ...
    from modules.background_tasks.translate_file_created_by_private_request.detect_content_language.main import main as detect_content_language
    
    from modules.background_tasks.translate_file_created_by_private_request.translate_content.docx.main import main as translate_content_docx
    from modules.background_tasks.translate_file_created_by_private_request.translate_content.pptx.main import main as translate_content_pptx
    from modules.background_tasks.translate_file_created_by_private_request.translate_content.txt.main import main as translate_content_txt
    from modules.background_tasks.translate_file_created_by_private_request.translate_content.xlsx.main import main as translate_content_xlsx
    
    # background_task_1_conf = BACKGROUND_TASKS['translate_file_created_by_private_request.detect_content_language']
    ...
    background_task_2_conf = BACKGROUND_TASKS['translate_file_created_by_private_request.translate_content.docx']
    ...
    background_task_3_conf = BACKGROUND_TASKS['translate_file_created_by_private_request.translate_content.pptx']
    ...
    background_task_4_conf = BACKGROUND_TASKS['translate_file_created_by_private_request.translate_content.txt']
    ...
    background_task_5_conf = BACKGROUND_TASKS['translate_file_created_by_private_request.translate_content.xlsx']
