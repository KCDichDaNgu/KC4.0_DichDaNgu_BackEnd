def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    from tests.background_tasks.translate_file_created_by_private_request.translate_content.xlsx.main import test_all

    background_task_1_conf = BACKGROUND_TASKS['test_translate_file_created_by_private_request.translate_content.xlsx']
