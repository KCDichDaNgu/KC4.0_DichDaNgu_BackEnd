def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.translate_plain_text_created_by_public_request.main import test_all
    background_task_1_conf = BACKGROUND_TASKS[
        'test_translate_plain_text_created_by_public_request.translate_content.test_all']
