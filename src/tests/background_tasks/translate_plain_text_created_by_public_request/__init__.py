def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.translate_plain_text_created_by_public_request.main import (
        test_read_task_result, test_mark_invalid_tasks, test_execute_in_batch, test_main)

    background_task_1_conf = BACKGROUND_TASKS[
        'test_translate_plain_text_created_by_public_request.translate_content.read_task_result']
    ...
    background_task_2_conf = BACKGROUND_TASKS['test_translate_plain_text_created_by_public_request.translate_content.mark_invalid_tasks']
    ...
    background_task_2_conf = BACKGROUND_TASKS[
        'test_translate_plain_text_created_by_public_request.translate_content.execute_in_batch']
    ...
    background_task_4_conf = BACKGROUND_TASKS[
        'test_translate_plain_text_created_by_public_request.translate_content.main']
