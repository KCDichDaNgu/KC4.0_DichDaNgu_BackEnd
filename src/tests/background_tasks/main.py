...
def init_test_background_tasks(config: GlobalConfig):
    ...
    from tests.background_tasks.detect_plain_text_language_created_by_private_request import add_fresh_jobs as add_fresh_jobs_7
    # from tests.background_tasks.detect_plain_text_language_created_by_public_request import add_fresh_jobs as add_fresh_jobs_8
