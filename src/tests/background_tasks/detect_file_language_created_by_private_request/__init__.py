...
def add_fresh_jobs(background_task_scheduler, BACKGROUND_TASKS):
    ...
    from tests.background_tasks.detect_file_language_created_by_private_request.main import test_all
    
    background_task_conf = BACKGROUND_TASKS['detect_file_language_created_by_private_request.test_all']
